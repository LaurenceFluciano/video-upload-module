...
## Aspectos positivos de arquitetura:
...
## Aspectos negativos da arquitetura:

Existe muitos DTOs e tipos entre os parametros e respostas das funções, o que pode confundir incialmente quem ler.

Muita separação em arquivos, ao passo que poderiamos ter uma única classe concreta realizando operação, essa abstração torna o entendimento inicial do código não tão natural.
